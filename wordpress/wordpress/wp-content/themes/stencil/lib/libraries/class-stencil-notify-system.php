...
class Stencil_Notify_System extends Epsilon_Notify_System {
	...
	public static function is_homepage_seted() {
		...
		if ( ! Stencil_Notify_System::is_not_static_page() ) {
			return false;
		}

		if ( ! Stencil_Notify_System::is_template_front_page() ) {
			return false;
		}
	...
	public static function has_old_content() {
		...
		$fields = Stencil_Lite_Helper::$stencil_fields;
	...
	public static function has_content() {
		...
		$content = get_post_meta( Stencil_Lite_Helper::get_setting_page_id(), 'regina-settings', true );
	...
	public static function check_installed_data() {
		...
		$import = get_option( 'stencil_lite_import_content' );
