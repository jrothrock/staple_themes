<?php
    ...
    $stencil_options_css .= 'a{color:' . $stencil_link_color . ';} ';
    $stencil_options_css .= 'a:hover{color:' . hex2rgba($stencil_link_color,'0.65') . ';} ';
    ...
    $stencil_options_css .= 'nav,.page-footer,.back-to-top:hover{background-color:' . $stencil_theme_color . ';}';
    $stencil_options_css .= '.back-to-top{background-color:' . hex2rgba($stencil_theme_color,'0.8') . ';}';
    $stencil_options_css .= 'nav > div > a, nav > div > div > ul > li > a, nav > div > div > ul > li > a:visited, nav > div > div > ul > li > a:visited:hover, nav > div > div > ul > li > a:hover, .footer-social-icons > a, .footer-copyright > div > a, nav .brand-logo, nav .brand-logo:hover, nav .brand-logo:visited:hover, nav .brand-logo:visited{color:' . $stencil_nav_footer_link_color . ';} ';
    $stencil_options_css .= '.btn{background-color:' . $stencil_button_color . ';} ';
